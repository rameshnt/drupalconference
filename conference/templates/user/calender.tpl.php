<div class="cf-user-menu">
  <ul>
    <li><a class="active" href="<?php echo base_path(); ?>conference/user/calender">Booking Calendar</a></li>
        <?php
      global $user;
...
<div class="cf-admin-calender-content <?=$logged;?>">
  <div class="calender-wrap">
    ...
    <div id="booking-form">
      ...
      <div class="form">
        ...
        <div class="form-ajax-submit">
          <button class="remove-user-booking">Cancel My Booking</button>
        </div>
      </div>
    </div>
